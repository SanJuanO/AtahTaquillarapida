...
public class CardAdapter_busqueda_guias extends RecyclerView.Adapter<CardAdapter_busqueda_guias.PlanetHolder> {

    private Context context;
    private ArrayList<Planet> planets;

    public CardAdapter_busqueda_guias(Context context, ArrayList<Planet> planets) {
        ...
        void bind(final Planet employee) {
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                        ...
                        Intent intent = new Intent(context, Reimprimir_guia.class);
